...
contextBridge.exposeInMainWorld('nekoNative', {
  ...
  playMpv: (items, title, startIndex, mpvPath, startSec, emby, tracks, scrobble) =>
    ipcRenderer.invoke('play-mpv', { items, title, startIndex, mpvPath, startSec, emby, tracks, scrobble }),
